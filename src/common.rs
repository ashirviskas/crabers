...
pub struct SimulationStats {
    ...
    pub max_hidden_neurons_history: VecDeque<[f64; 2]>,
    pub median_hidden_neurons_history: VecDeque<[f64; 2]>,
    pub p25_hidden_neurons_history: VecDeque<[f64; 2]>,
    pub p75_hidden_neurons_history: VecDeque<[f64; 2]>,
    pub avg_connections_history: VecDeque<[f64; 2]>,
    pub max_connections_history: VecDeque<[f64; 2]>,
    pub median_connections_history: VecDeque<[f64; 2]>,
    pub p25_connections_history: VecDeque<[f64; 2]>,
    pub p75_connections_history: VecDeque<[f64; 2]>,
...
impl SimulationStats {
    pub fn new(capacity: usize) -> Self {
        Self {
            ...
            max_hidden_neurons_history: VecDeque::with_capacity(capacity),
            median_hidden_neurons_history: VecDeque::with_capacity(capacity),
            p25_hidden_neurons_history: VecDeque::with_capacity(capacity),
            p75_hidden_neurons_history: VecDeque::with_capacity(capacity),
            avg_connections_history: VecDeque::with_capacity(capacity),
            max_connections_history: VecDeque::with_capacity(capacity),
            median_connections_history: VecDeque::with_capacity(capacity),
            p25_connections_history: VecDeque::with_capacity(capacity),
            p75_connections_history: VecDeque::with_capacity(capacity),
